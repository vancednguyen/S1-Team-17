...
CREATE TABLE `car` (
  ...
  `bag_capacity` int DEFAULT NULL,
  `availability` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`car_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `car_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `owner` (`user_id`)
