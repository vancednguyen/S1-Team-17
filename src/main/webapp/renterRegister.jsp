...
<html>
<head>
    <title>Ouroboros EV - Renter Registration</title>
    <style>
...
<div class="page">
    <div class="form-card">
        ...
        <div class="sub">Create your renter account to start booking EVs</div>
        ...
        <form action="RenterRegisterServlet" method="post">
            <div class="field">
                <label>Email *</label>
            ...
            <div class="field">
                ...
                <div class="hint">Used to coordinate with owners</div>
            </div>
            <div class="field">
            ...
            <button type="submit" class="btn-submit">Create renter account</button>
        </form>

        <div class="already">Already have an account? <a href="login.jsp">Log in</a></div>
        <div class="already" style="margin-top:8px;">Not a renter? <a href="ownerRegister.jsp">Register as owner</a></div>
    </div>
</div>
